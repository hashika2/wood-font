...
function FullPackage({ ChangeStep, setPath }) {
  ...
  // State to manage clean fee, piece fee, load fee, and charges calculation
  ...
  const CalculateCharges = () => {
    if (
      ...
      setCharges(true);
      let circumference = parseInt(packageData.circumference);
      let height = parseInt(packageData.height);
      ...
      // Update clean fee from the selected tree type
      ...
      // Calculate the total cost including the subtotal, transport fee, clean fee, piece fee, and load fee
        ...
        <div className="detail-box">
          <div className="border-box">
            <Fade right duration={1000} distance="50px">
              <div className="detail-title">Cutting - Full Package</div>
            </Fade>
